...
public class DataGestorViewController {
    ...
    private void initDetails() {
        ...
        tableUsers.getStylesheets().add(getClass().getResource(PathConstants.TABLE_USERS_CSS.getPath()).toExternalForm());
        ...
        columnDelete.setCellFactory(param -> new TableCell<>() {
...

            {
                ...
                deleteButton.setOnAction(event -> {
                    ...
                    Image image = new Image(getClass().getResource(PathConstants.DELETE_ICON.getPath()).toExternalForm());
